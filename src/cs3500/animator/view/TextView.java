 ...
 * class will take care of creating an new output file if it does not exist, writing the animation
 * description generated by the model to the output file, and close the writing when done.
 */
