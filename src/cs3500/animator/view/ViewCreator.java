...
/**
 * Factory class to create a view based on input arguments from cs3500.animator.main.
 * This can create 3 different types of view: svg, text, and swing (visual) view.
 */
